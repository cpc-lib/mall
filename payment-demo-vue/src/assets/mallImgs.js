// 商城商品占位图（text_to_image 生成，按商品 id 轮换）
...
export function mallImg(id) { return MALL_IMGS[Number(id || 0) % MALL_IMGS.length] }
...
export function onMallImgError(e) { if (!String(e.currentTarget.src).startsWith('data:')) e.currentTarget.src = MALL_IMG_FALLBACK }
