...
import { Button, Descriptions, Drawer, Input, message, Modal, Space, Table, Tag, Typography } from 'antd'
import authApi from '@/api/auth'

// 密码重置申请：列表 + 详情抽屉（申请信息 + 受理生成随机密码 / 拒绝）
export default function AdminResetRequests() {
  ...
  return <div>
    <h2 className="adm-page-title">密码重置申请</h2>
