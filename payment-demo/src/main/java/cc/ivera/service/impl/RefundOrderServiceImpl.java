...
public class RefundOrderServiceImpl implements RefundOrderService {
    ...
    public RefundApplyVO create(Long userId, RefundApplyRequest request) {
        return lockTemplate.execute("refund:create:" + request.getOrderNo(), 5000L, -1L, () ->
                tx.execute(s -> doCreate(userId, request, null)));
    }
    ...
    public RefundApplyVO cancelPaidOrder(Long userId, String orderNo) {
        return lockTemplate.execute("refund:create:" + orderNo, 5000L, -1L, () ->
                tx.execute(s -> doCancelPaidOrder(userId, orderNo)));
    }
    ...
    private RefundApplyVO doCreate(Long userId, RefundApplyRequest request, String forcedType) {
    ...
    private RefundApplyVO doCancelPaidOrder(Long userId, String orderNo) {
        ...
        return doCreate(userId, request, RefundType.CANCEL_BEFORE_SHIP.getType());
    }
