 ...
 */
@RestController @RequestMapping("/api/admin/password-reset-requests") @CrossOrigin
...
public class AdminPasswordResetRequestController {
    ...
    @GetMapping
    public R<List<PasswordResetRequest>> list() { return R.ok(passwordResetRequestService.list()); }
